...
const data = {
    ...
    content: ((redirect) => <>
        ...
        <p>
            ...
            <br/>
            Check out the Repository on <span onClick={() => redirect("https://github.com/fcmnetwork/FCM-Essentials")} className="clickable">Github</span> or download it in <span onClick={() => redirect('/downloads')} className="clickable">Downloads</span>
        </p>
    </>)
}
